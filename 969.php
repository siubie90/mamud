...
echo  "\ e [96m  INI SCRIPT MAMA MUDA \ n" ;
echo  "\ e [96m  JANGAN NAKSIR LHO YA \ n" ;
echo  "\ e [96 m TIDAK DI JUAL BELIKAN \ n" ;
echo  "\ e [96m  KHUSUS YANG BESAR SAJA: \ n" ;
echo  "\ e [96m TAK TUNGGU DI HOTEL YA \ n" ;
echo  "\ e [96 m BIAR TAMBAH KUAT MINUM JAMUNYA \ n" ;
echo  "\ e [96m * AYO DI GOYANG_SAMPAI PAGI * \ n" ;
gema  "\ e [96m ******** \ e [95m" . tanggal ( '[dmY] [H: i: s]' ). "\ e [96m ******** \ n" ;
echo  "\ e [95m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ▬▬▬▬▬▬▬▬▬▬▬▬ \ n " ;
echo  "\ e [96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ▬▬▬ \ n " ;
echo  "\ e [93m \ e [96m WES ORA USAH KESUWEN \ e [93m \ n" ;
echo  "\ e [96m ============================================ == \ n " ;
echo  "\ e [96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ▬▬▬ \ n " ;
echo  "\ e [95m ID Wes gowo jamune (Y / T?:" ;	
$ pilihy = trim ( fgets ( STDIN ));
if ( $ pilihy == "y" || $ pilihy == "sudah" )
echo  "\ e [96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ▬▬▬ \ n " ;
	login goto;
Gabung:
echo  "\ e [96 m▬▬▬ WES DANG DI BUKAK CLONONE ▬▬▬▬▬ \ n" ;
$ pass = ( '║ Login Pengguna:' );
gema  "\ 033 [30; 40m" ;
...
else
{
		echo "\e[96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";	
		echo "\e[91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
		echo "\e[96m[🚫]        \e[91mKAN WES TAK KANDANI         \e[96m [🚫]\n";
	        echo "\e[96m[🚫]              \e[91mBUKAK  WAE        \e[96m [🚫]\n";
		echo "\e[96m[🚫]           \e[91mSEK NGEYEL WAE      \e[96m [🚫]\n";
	        echo "\e[96m[🚫] \e[91mOPO DURUNG TAU DI BUKAKNE SUSU TA \e[96m [🚫]\n";
		echo "\e[91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
goto login;
}
	return rtrim( $input, "\n" );
ulang:
echo "\n";
echo "\e[96m ( OJOK LALI LEK WES MARI NUMPAK DANG BAYAR $input)        \n";
echo "\e[89m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
// function change(){
        $nama = nama();
        ...
        echo color("green","📶▶️ OTP WES CROTT ")."\n";
        otp:
        echo color("yellow","💬▶️ OTP COK : ");
        ...
        echo color("nevy","\n▬▬▬▬▬▬▬▬▬▬▬▬* SANTUY SEK YOW *▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("nevy","# CLAIM VOUCHER RONDE SIJI ");
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
	      gocar:
        echo "\n".color("nevy","# CLAIM VOUCHER RONDE LORO ");
        echo "\n".color("yellow","# WES CROOTTT , WKWKWKWK ");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
        }
        ...
        $TOKEN  = "0000000000:7V93cvCvw1DNuTk0Hp1ZFywJGmjiP7aQ";
         ...
         echo color("nevy","▬▬▬▬▬▬▬▬▬▬▬▬▬▬🔧 PIN GOPAY = 696969 🔧▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"696969"}';
         ...
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
         echo color("purple","!] LEBOKNO MANEH SALAH LHO\n");
         goto ulang;
         }
         }else{
